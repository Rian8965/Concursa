...
export function CompetitionTabs({ competitionId }: { competitionId: string }) {
  ...
  return (
    <div className="flex gap-0.5 overflow-x-auto rounded-lg border border-black/[0.06] bg-[#F9FAFB] p-2.5 my-2.5 mx-[5px] scrollbar-none">
      {TABS.map((tab) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              "flex items-center gap-1.5 whitespace-nowrap rounded-md px-2.5 py-2.5 text-[12.5px] transition-all",
              isActive
